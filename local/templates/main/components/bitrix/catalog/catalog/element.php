...
elseif ($obCache->StartDataCache()):
    $arCurItem = array();
    $dbRes = CIBlockElement::GetList(array(), $arFilter, false, Array("nTopCount"=>"1"), array("ID", "IBLOCK_ID", "PROPERTY_KRESLO"));
...
$template = $arCurItem["PROPERTY_KRESLO_VALUE"] == "Y" ? "chair" : "";
