            ...
            foreach($arItem["OFFERS"] as $offerId=>$arOffer):?>
                <div class="info_slider_section offer<?if(!$first):?> hide<?endif; $first = false;?>" data-offer="<?=$offerId?>">
                    ...
                    <div class="how_many">
                        <div class="left">
                            <?$statusCount = 0;
                            foreach($arOffer["STATUS"] as $statusText=>$statusValue):
                                if(++$statusCount == 3):?>
                                    </div>
                                    <div class="right">
                                <?endif;?>
    ...
    <div class="wrap">
        <div class="wrap_tab_links">
            <div class="tab_links">
                ...
                <span data-tabLinks="configurator"<?if($_REQUEST["tab"] == "configurator"):?> class="active"<?endif?>>Собрать свой вариант</span>
                ...
                <?if(
                    ...
                    <span data-tabLinks="files"<?if($_REQUEST["tab"] == "projects"):?> class="active"<?endif?>>Скачать</span>
                <?endif?>
            </div>
        </div>
        <div class="tab_blocks">
            ...
            <div data-tabContent="configurator"<?if($_REQUEST["tab"] == "configurator"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
            ...
            <div data-tabContent="description"<?if($_REQUEST["tab"] == "description"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
            ...
            <div data-tabContent="files"<?if($_REQUEST["tab"] == "files"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
                <div class="grid">
