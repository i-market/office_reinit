...
<section class="prof_kabinet_tabs">
    <div class="wrap">
        <div class="wrap_tab_links">
            <div class="tab_links">
                <span data-tabLinks="products"<?if($_REQUEST["tab"] == "products" || !$_REQUEST["tab"]):?> class="active"<?endif?>>Готовые изделия</span>
                <?if($arResult["ITEMS"]["complect"]):?>
                    <span data-tabLinks="complect"<?if($_REQUEST["tab"] == "complect"):?> class="active"<?endif?>>Комплектующие</span>
                <?endif?>
                <?if($arResult["ITEMS"]["dopoborud"]):?>
                    <span data-tabLinks="dopoborud"<?if($_REQUEST["tab"] == "dopoborud"):?> class="active"<?endif?>>Доп. оборудование</span>
                <?endif?>
                <?if($arResult["VARIANTS"]):?>
                    <span data-tabLinks="variants"<?if($_REQUEST["tab"] == "variants"):?> class="active"<?endif?>>Расстановки</span>
                <?endif?>
                <?if($arResult["DESCRIPTION"]):?>
                    <span data-tabLinks="description"<?if($_REQUEST["tab"] == "description"):?> class="active"<?endif?>>Описание</span>
                <?endif?>
                <?if($arResult["PROJECTS"]):?>
                    <span data-tabLinks="projects"<?if($_REQUEST["tab"] == "projects"):?> class="active"<?endif?>>Проекты</span>
                <?endif?>
            </div>
        </div>
        <div class="tab_blocks">
            <div data-tabContent="products" <?if($_REQUEST["tab"] == "products" || !$_REQUEST["tab"]):?> style="display: block"<?else:?> style="display:none"<?endif?>>
                <?if(count($arResult["COLORS"]) > 1 || count($arResult["CATEGORY_LIST"]) > 1):?>
                    <div class="filterContainer">
                        <?if(count($arResult["CATEGORY_LIST"]) > 1):?>
                ...
                <div class="grid category-items">
                    ...
                    foreach($arResult["ITEMS"] as $categoryCode=>$arItems):
                        ...
                        foreach($arItems as $itemId=>$arItem):
                            ...
                            $arItem["CLASS"] = "category-item {$categoryCode} ".implode(" ", $arItem["COLOR_LIST"])?>
                            <?=itemCard($arItem)?>
                        <?endforeach;
                    endforeach?>
                </div>
            ...
            <?if($arResult["ITEMS"]["complect"]):?>
                <div data-tabContent="complect"<?if($_REQUEST["tab"] == "complect"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
                    <div class="grid">
            ...
            <?if($arResult["ITEMS"]["dopoborud"]):?>
                <div data-tabContent="dopoborud"<?if($_REQUEST["tab"] == "dopoborud"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
                    <div class="grid">
            ...
            <?if($arResult["VARIANTS"]):?>
                <div data-tabContent="variants" class="description_block"<?if($_REQUEST["tab"] == "variants"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
            ...
            <div data-tabContent="description" class="description_block" <?if($_REQUEST["tab"] == "description"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
                <div class="wrap_min">
            ...
            <?if($arResult["PROJECTS"]):?>
                <div data-tabContent="projects" <?if($_REQUEST["tab"] == "projects"):?> style="display: block"<?else:?> style="display:none"<?endif?>>
                    <div class="grid">
