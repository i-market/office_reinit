...
<section class="complaints">
    <div class="wrap">
        <div class="complaints-top">
            <a class="complaints__create-link" href="#">создать новую рекламацию</a>
            <a class="complaints-rules" href="#">Правила работы с рекламацией</a>
        </div>
        <div class="wrap-complaints-table">
            <div class="complaints-table">
                ...
                <div class="tbody">
                    <div class="tr">
                        <div class="tr-line">
                            <div><span class="number"></span>12.12.2017</div>
                            <div>132-890-м</div>
                            <div><span class="open-table-inner">Не функционирует доводчик</span>
                            </div>
                            ...
                            <div class="complaints-table__inner-block">
                                ...
                                <div class="top">
                                    <div class="line">
                                        ...
                                        <span class="text">ООО „Дизайн-шайн”</span>
                                    </div>
                                    <div class="line">
                                        <span class="title">НОМЕР ЗАКАЗА</span>
                                        <span class="text">123-466-К</span>
                                    </div>
                                    <div class="line">
                                        <span class="title">ДАТА ОТГРУЗКИ</span>
                                        <span class="text">123-466-К</span>
                                    </div>
                                    <div class="line">
                                        <span class="title">НОМЕР ЗПК</span>
                                        <span class="text">123-466-К</span>
                                    </div>
                                    <div class="line">
                                        <span class="title">ТОВАРНЫЙ НОМЕР</span>
                                        <span class="text">123-466-К</span>
                                    </div>
                                    <div class="line">
                                        <span class="title">НАИМЕН. ТОВАРА</span>
                                        <span class="text">123-466-К</span>
                                    </div>
                                    <div class="line">
                                ...
                                <div class="description">
                                    <p class="title">ОПИСАНИЕ ПРЕТЕНЗИИ</p>
                                    <p class="text">при ближайщем рассмотрении цвет светлый орех никак не сооветствует заявленному светлому дубу</p>
                                </div>
                                <div class="images">
                                    <span class="title">ПРИКРЕПЛЕННЫЕ ИЗОБРАЖЕНИЯ</span>
                                    <div class="inner">
                                        <div class="img">
                                            <a class="gallery" href="images/pic_49.png">
                                                <img src="images/pic_49.png" alt="">
                                            </a>
                                            <p class="text">при дневном освещении</p>
                                        </div>
                                        <div class="img">
                                            <a class="gallery" href="images/pic_49.png">
                                                <img src="images/pic_49.png" alt="">
                                            </a>
                                            <p class="text">при офисном освещении</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="comments">
                                    <p class="title">КОММЕНТАРИИ profoffice</p>
                                    <p class="text">фотошоп и провокация!</p>
                                </div>
                            </div>
                        </div>
                    </div>
